...
{
    public static class CalculaFeriados
    {
        //https://medium.com/@AlexandreSanlim/lista-de-feriados-nacionais-c-c61bf68ac973
        public static List<Feriado> ObtemFeriadosNacionais(int? ano = null)
        {
